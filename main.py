...
with input:
    ...
    speckleToken = tokenCol.text_input("Speckle token", "5f318b8093", help="If you don't know how to get your token, take a look at this [link](https://speckle.guide/dev/tokens.html)👈")
    #-------
